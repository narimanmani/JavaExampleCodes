...
public class AirlineProblem {
    ...
    private static final String PATHTOFILE = "D:\\git\\Ex_Files_First_Spring_Boot_Microservice\\Exercise Files\\Chapter 2\\02_02\\untitled\\src\\main\\java\\airlines.txt";

    public static void main(String[] args) throws IOException {
        List<Airline> airlinesPartnersNetwork = readAirlinesFile(PATHTOFILE);
        ...
        findPath(airlinesPartnersNetwork, start, goal, pathForMiles, airlinesVisited);
    }

    private static void findPath(List<Airline> airlinesPartnersNetwork, String start, String goal, ArrayList<String> pathForMiles, ArrayList<String> airlinesVisited) {
    ...
    private  static List<Airline> readAirlinesFile(String filePath) throws IOException {
        ...
        try ( Stream<String> stream = Files.lines(Paths.get(filePath)))
        {
            ...
            airlinesPartnersNetwork = stream.map(s -> new Airline(s.split(","))).collect((Collectors.toList()));
        ...
        return airlinesPartnersNetwork;
    }
